...
/**
 * Utility class to encrypt some messages to send to Test Navigator production environment.
 */
public class OmTnProEncryptor
{
	...
	public static String encrypt(String message)
	{
		...
		String password=getConfigurationService().getOmTnProEncryptionPassword();
		if (password!=null)
		{

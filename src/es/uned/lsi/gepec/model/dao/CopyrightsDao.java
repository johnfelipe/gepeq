...
/**
 * Manages access to copyright data.
 */
public class CopyrightsDao
{
	private Operation operation=null;
	private boolean singleOp;
	
	/**
	 * Adds a new copyright to DB.
	 * @param copyright Copyright
	 * @return Copyright identifier
	 * @throws DaoException
	 */
	public long saveCopyright(Copyright copyright) throws DaoException
	{
		long id=0L;
		try
		{
			startOperation();
			id=((Long)operation.session.save(copyright)).longValue();
			if (singleOp)
			{
				operation.commit();
			}
	...
	/**
	 * Updates a copyright on DB.
	 * @param copyright Copyright
	 * @throws DaoException
	 */
	public void updateCopyright(Copyright copyright) throws DaoException
	{
		try
		{
			startOperation();
			operation.session.update(copyright);
			if (singleOp)
			{
				operation.commit();
			}
	...
	/**
	 * Deletes a copyright from DB.
	 * @param copyright Copyright
	 * @throws DaoException
	 */
	public void deleteCopyright(Copyright copyright) throws DaoException
	{
		try
		{
			startOperation();
			operation.session.delete(copyright);
			if (singleOp)
			{
				operation.commit();
			}
	...
	/**
	 * @param id Copyright identifier
	 * @return Copyright from DB
	 * @throws DaoException
	 */
	public Copyright getCopyright(long id) throws DaoException
	{
		Copyright copyright=null;
		try
		{
			startOperation();
			copyright=(Copyright)operation.session.get(Copyright.class,id);
		}
		catch (HibernateException he)
		{
	 ...
	 * @throws DaoException
	 */
	public Copyright getCopyright(String copyrightStr) throws DaoException
	{
		Copyright copyright=null;
		try
		{
			startOperation();
			Query query=operation.session.createQuery("from Copyright c where c.copyright = :copyright");
			query.setParameter("copyright",copyrightStr,StandardBasicTypes.STRING);
			copyright=(Copyright)query.uniqueResult();
		}
		catch (HibernateException he)
		{
			handleException(he,!singleOp);
	...
	public List<Copyright> getCopyrights() throws DaoException
	{
		List<Copyright> copyrights=null;
		try
		{
			startOperation();
			copyrights=operation.session.createQuery("from Copyright").list();
		}
		catch (HibernateException he)
		{
			handleException(he,!singleOp);

...
public class UIRepeat extends UINamingContainer {
    ...
    public void process(FacesContext faces, PhaseId phase) {
        ...
        // UNED - dballestin - 06-02-2012 - patch to recognize model updates (http://kpachar.blogspot.com/2010/07/whats-wrong-with-jsf-2-uirepeat.html)
    ...
    private final static class SavedState implements Serializable {
        ...
        public void populate(EditableValueHolder evh) {
            // UNED - dballestin - 06-02-2012 - patch to avoid ui:repeat botches up input fields - checkboxes, textboxes and all sorts of EditableValueHolders in general (http://kpachar.blogspot.com/2010/07/whats-wrong-with-jsf-2-uirepeat.html)

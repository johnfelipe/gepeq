...
-- Started on 2013-07-04 14:57:28
...
--
-- TOC entry 2194 (class 1262 OID 17350)
-- Name: gepeq; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE @gepeq.dbname@ WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Spanish_Spain.1252' LC_CTYPE = 'Spanish_Spain.1252';


ALTER DATABASE @gepeq.dbname@ OWNER TO postgres;

\connect @gepeq.dbname@
...
INSERT INTO usertypes (type, id, description) VALUES ('@gepeq.adminusertype.type@', 1, '@gepeq.adminusertype.description@');
...
INSERT INTO users (login, password, name, surname, id, id_type, nick, gepeq_user, oucu) VALUES ('@gepeq.rootuser.login@', '@gepeq.rootuser.password@', '@gepeq.rootuser.name@', '@gepeq.rootuser.surname@', 1, 1, '@gepeq.rootuser.nickname@', true, '@gepeq.rootuser.oucu@');
...
-- Completed on 2013-07-04 14:57:28
